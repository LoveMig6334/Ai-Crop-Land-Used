...
\begin{table}[htbp]
  ...
  \end{tabular}
  \vspace{2pt}
  \raggedright\scriptsize Ca=Cassava, Co=Corn, GB=Green Bean, So=Soybean. Income in THB/rai/year. Horizontal rules separate 4/4, 3/4, and 2/4 crop schedules. The greedy heuristic (income-first ordering) corresponds to ranks 13--14.
\end{table}
