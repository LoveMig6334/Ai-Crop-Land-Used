...
\begin{table}[htbp]
  ...
  \begin{tabular}{clccc}
    ...
    \midrule
    1  & Ca$\to$GB$\to$Co$\to$So & 4/4 & 39,211 & 100.0\% \\
    2  & Ca$\to$So$\to$GB$\to$Co & 4/4 & 39,211 & 100.0\% \\
    3  & GB$\to$Ca$\to$Co$\to$So & 4/4 & 39,211 & 100.0\% \\
  ...
  \end{tabular}
  \vspace{2pt}
  \raggedright\scriptsize Ca=Cassava, Co=Corn, GB=Green Bean, So=Soybean. Income in THB/rai/year. Of the 14~omitted middle entries (ranks 6--19), 5~achieve 4/4 crops (35,706--37,479~THB) and 9~achieve 3/4 crops (29,790--33,717~THB).
\end{table}
